...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        bool MainWindow = ImGui::Begin("Main Window", &open, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoTitleBar);

        if (MainWindow)
        {
            ImGui::SetWindowFontScale(1.5f); // Font Size
